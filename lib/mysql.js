...
var Connection = function(hostname, username, password, dbname, port) {
    ...
    this.last_error = undefined; // TODO
...
Connection.prototype.connect = function(callback, errback) {
    ...
    this.protocol.authenticate(this.connect_parameter[1], this.connect_parameter[2], this.connect_parameter[3], (this.local_infile ? constants.client.LOCAL_FILES : 0), 'utf8_general_ci').addCallback(callback).addErrback(errback);
}
