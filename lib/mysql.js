...
Connection.prototype.connect = function() {
    ...
    var promise = this.protocol.authenticate(this.connect_parameter[1], this.connect_parameter[2], this.connect_parameter[3], undefined, 'utf8_unicode_ci');
    // this.query(scope(this, function(){"SET NAMES '"+this.charset.name+"'"}));
    return promise;
}
