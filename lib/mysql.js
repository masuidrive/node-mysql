...
Connection.prototype.connect = function(callback, errback) {
    ...
    var promise = this.protocol.authenticate(this.connect_parameter[1], this.connect_parameter[2], this.connect_parameter[3], undefined, 'utf8_general_ci');
    this.query(scope(this, function(){return "SET NAMES '"+this.protocol.charset.name+"'"}));
...
Stmt.prototype.prepare = function(statement, callback, errback) {
    this.close();
    this.protocol.stmt_prepare_command(statement)
